...
blitemoth: blitemoth_main.c blitemoth_cli.o ppmio.o
	$(CC) $(CFLAGS) -o blitemoth \
		blitemoth_main.c blitemoth_cli.o ppmio.o

blitemoth_cli.o: blitemoth_cli.c blitemoth_cli.h blitemoth_info.h
